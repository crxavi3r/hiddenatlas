  ...
  return (
    <div
      ...
      style={{
        ...
        boxShadow: hovered
          ? '0 20px 60px rgba(28,26,22,0.12)'
          : '0 2px 16px rgba(28,26,22,0.05)',
    ...
    >
      ...
      <div style={{ position: 'relative', height: '200px', overflow: 'hidden', flexShrink: 0 }}>
        ...
        <div style={{
          ...
          background: 'linear-gradient(to top, rgba(28,26,22,0.5) 0%, transparent 55%)',
        }} />
        {/* Purchased badge */}
        <div style={{
      ...
      <div style={{ padding: '22px 22px 20px', display: 'flex', flexDirection: 'column', flex: 1 }}>
        <h3 style={{
          ...
          color: '#1C1A16', lineHeight: '1.3', marginBottom: '8px',
        }}>
          {trip.title}
        </h3>
        ...
        <div style={{
          ...
          fontSize: '12px', color: '#9C9488', marginBottom: '20px',
        }}>
          ...
          {trip.pdfUrl ? (
            <a
              ...
              onMouseEnter={e => {
                ...
                e.currentTarget.style.color = '#1B6B65';
              }}
              onMouseLeave={e => {
            ...
            <span style={{
              ...
              display: 'inline-flex', alignItems: 'center', justifyContent: 'center', gap: '6px',
              padding: '11px 16px',
              background: '#F4F1EC', color: '#B5AA99',
              border: '1px solid #E8E3DA',
              borderRadius: '4px',
              fontSize: '12.5px', fontWeight: '600',
              letterSpacing: '0.4px', textTransform: 'uppercase',
...
export default function MyTrips() {
  ...
  useEffect(() => {
    fetch(`${API_BASE}/api/my-trips/${PLACEHOLDER_USER_ID}`)
      .then(res => {
      ...
      <section style={{ background: '#F4F1EC', padding: 'clamp(48px, 7vw, 88px) 24px', borderBottom: '1px solid #E8E3DA' }}>
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          <span style={{
            ...
            textTransform: 'uppercase', color: '#1B6B65', display: 'block', marginBottom: '14px',
          }}>
            My Library
          </span>
          <h1 style={{
            ...
            lineHeight: '1.15', letterSpacing: '-0.3px', marginBottom: '12px',
          }}>
            Your purchased itineraries.
          </h1>
          <p style={{ fontSize: '16px', color: '#6B6156', lineHeight: '1.7', maxWidth: '480px' }}>
            Access your full itineraries online or download the PDF to take offline.
          </p>
        </div>
      </section>
        ...
        <div style={{ maxWidth: '1100px', margin: '0 auto' }}>
          ...
          {status === 'error' && (
            <div style={{
              ...
              background: 'white', borderRadius: '10px', border: '1px solid #E8E3DA',
            }}>
              <p style={{ fontSize: '15px', color: '#6B6156', marginBottom: '8px' }}>
                Couldn't load your trips right now.
              </p>
              <p style={{ fontSize: '13px', color: '#9C9488' }}>
                Make sure the server is running on <code>localhost:4000</code>.
              </p>
            </div>
          )}
          ...
          {status === 'empty' && (
            <div style={{
              ...
              <p style={{
                fontFamily: "'Playfair Display', Georgia, serif",
                fontSize: '22px', fontWeight: '600', color: '#1C1A16', marginBottom: '12px',
              }}>
                No trips yet.
              </p>
              ...
              <Link
                ...
                style={{
                  ...
                  padding: '13px 26px',
                  background: '#1B6B65', color: 'white',
                  borderRadius: '4px', fontSize: '13.5px', fontWeight: '600',
          ...
          {status === 'ok' && (
            <>
              ...
              <div style={{
                ...
                {trips.map(trip => (
                  <TripCard key={trip.purchaseId} trip={trip} />
                ))}
              </div>
            </>
          )}
