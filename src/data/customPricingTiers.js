...
export const CUSTOM_TIERS = [
  {
    ...
    features: [
      ...
      'Curated accommodation suggestions',
      'Suggested places and experiences to explore',
      'Travel route and pacing guidance',
  ...
  },
  {
    ...
    features: [
      ...
      'Accommodation options suitable for groups',
      'Suggestions for places and experiences to explore together',
      'Travel route and pacing guidance for groups',
  ...
  },
  {
    ...
    features: [
      ...
      'Accommodation research for larger groups',
      'Guidance for multi-destination trips',
      'Suggested places and experiences to explore',
      'Child and multi-generation travel considerations',
      'Unlimited revisions',
      'Final digital itinerary package (PDF)',
    ],
  },
  {
    ...
    features: [
      ...
      'Guidance for complex multi-destination trips',
      'Unlimited revisions',
      'Final digital itinerary package (PDF)',
    ],
  },
