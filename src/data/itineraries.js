...
export const itineraries = [
...

  {
    ...
    days: [
      ...
      {
        day: 3,
        title: "Gorges, Canyon Roads and Kasbah Country",
        desc: "The gorge roads are the highlight of the southern route. Todra Gorge comes first: 300-metre limestone walls pressing in on both sides of the river, the canyon floor barely wide enough for two vehicles. The light inside the gorge changes by the hour; mid-morning offers the best balance of manageable traffic and dramatic illumination.\n\nFrom Todra, the road west through the Dades Valley runs along the base of a long escarpment, past a succession of mud-brick kasbahs and palmeries strung along the river. The Dades Gorge switchbacks are a set piece. The road climbs in tight bends above the valley with the kasbah village of Aït Arbi below. This section gets discussed among motorcycle groups because it earns the discussion.\n\nAït Benhaddou is the last stop, an hour before Ouarzazate. The fortified ksar on the far bank of the Ounila River is best in late afternoon when the mud towers catch the low light. Cross the footbridge on foot.",
        bullets: [
          "Todra Gorge: 300-metre limestone canyon walls above the Todra River",
          "Dades Valley road: palmeries, mud-brick kasbahs and a long cliff-edge escarpment",
      ...
      {
        day: 4,
        title: "Across the Atlas to the Dunes",
        desc: "The approach to Merzouga from the west crosses some of the most cinematically striking road in Morocco. From Aït Benhaddou, the route passes through Ouarzazate, a useful fuel and food stop before the long desert run, and continues east toward Zagora and then north through the Draa Valley. This river corridor, lined with palmeries on both sides, bisects an otherwise bare plateau of dark hammada.\n\nThe dunes appear in the final thirty kilometres before Merzouga as a dark orange rise against the flat horizon. Erg Chebbi is not the largest erg in the Sahara, but its scale in context is remarkable: two-hundred-metre dune ridges rising abruptly from a stony plain. Watching the ridge line resolve from a smudge to something unambiguous, on a motorcycle, is one of those arrivals that stays with a group.\n\nCheck in. Let the bikes rest. The light on the dunes in the late afternoon is reason enough to go no further today.",
        bullets: [
          "Ouarzazate: the so-called gateway to the Sahara; fuel and food stop before the desert run",
          "Draa Valley: Morocco's longest river valley, lined with palmeries and mud kasbahs",
          "Desert hammada: the flat stony plateau that defines the pre-Saharan landscape",
      ...
      },
      {
        ...
        desc: "The return ride from Merzouga to Marrakech is the longest single day of the route: roughly 500 kilometres depending on road choices through the Atlas. It is a day of sustained riding rather than destination stops, and the group will experience it as a transition between two very different Moroccos.\n\nThe first hours retrace the approach through the Draa Valley, the light now falling on the opposite face of the kasbahs. Past Ouarzazate, the road north climbs into the High Atlas through the Tizi n'Tichka pass at 2,260 metres, the highest road pass in North Africa, with switchbacks, layered rock strata in colours that shift from ochre to charcoal, and views down both sides of the range. This is the visual culmination of the southern section.\n\nMarrakech arrives quickly on the far side of the descent. The city comes fast: the suburban sprawl, the palm-lined boulevards, then the ochre walls of the medina. After the desert and the gorges, arriving at Djemaa el-Fna for the first time feels like the volume being turned up. That is exactly the right way to arrive.",
        bullets: [
          "Tizi n'Tichka pass: the High Atlas crossing at 2,260 metres, North Africa's highest main road",
          "Atlas switchbacks: descent toward Marrakech through layered mountain geology",
    ...
    whySpecial: "Morocco's reputation for motorcycle travel rests on a handful of roads that have spread through word of mouth for decades. This route connects them without padding: the Rif descent into Chefchaouen, the Dades switchbacks, the Tizi n'Tichka at altitude and the desert approach to Erg Chebbi. But the route works because of what happens between the set pieces. Two nights in the Sahara is not a luxury. It is the correct amount of time. One night gives you the sunset and nothing else. Two nights gives you a full day in the desert, a 4x4 into the dune field, and a second sunset on a ridge you chose yourself. That experience does not exist in a shorter version. The final two days along the Atlantic coast, covering Oualidia's lagoon, the Hassan II Mosque and Rabat's under-visited medina, bring the route back to the sea cleanly, with the Strait and the ferry home as the last frame.",
    routeOverview: "Algeciras/Tarifa → Ceuta/Tangier Med → Chefchaouen → Fes → Azrou → Midelt → Errachidia → Todra Gorge → Dades Gorge → Aït Benhaddou → Ouarzazate → Draa Valley → Merzouga (2 nights) → Tizi n'Tichka → Marrakech → Atlantic Coast → Oualidia → Casablanca → Rabat → Tangier → Ferry home",
  },
