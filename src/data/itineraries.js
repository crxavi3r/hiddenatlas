...
export const itineraries = [
...

  {
    ...
    tagline: "Palawan's hidden lagoons, karst islands and the quiet shore of Boracay",
    shortDescription: "San Vicente's untouched Long Beach, El Nido's secret lagoons, Coron's WWII wrecks and crystalline lakes, and the quiet northern end of Boracay. The Philippines, planned without compromise.",
    country: "Philippines",
    region: "Palawan",
    duration: "17 days",
    nights: "15",
    ...
    days: [
      {
        ...
        route: "Manila",
        desc: "Land at Ninoy Aquino International Airport and settle into accommodation near the terminal. Manila does not need to be decoded in a single evening, and the plan does not ask you to try. The airport area offers reliable hotels and enough good eating within a short ride to make a first meal in the Philippines worth remembering.",
        bullets: [
          "Ninoy Aquino International Airport: the main international gateway to the Philippines",
          "Airport district restaurants: a first dinner in the Philippines without the pressure of a city itinerary",
          "Manila Bay at sunset: visible on the approach road, a preview of the coastal light that follows throughout the route",
        ],
      ...
      },
      {
        ...
        desc: "The morning flight to San Vicente arrives at one of the least known beaches in Southeast Asia. Long Beach runs for 14 kilometres along the northwest coast of Palawan, backed by coconut groves and undeveloped aside from a handful of small guesthouses. The sand is white, the water is clear, and there is almost no infrastructure in the sense that modern beach tourism normally provides. This is the Philippines before the hotels arrived.",
        bullets: [
          "San Vicente, Palawan: a small municipality on the northwest coast, almost entirely undiscovered by mass tourism",
          "Long Beach: 14 kilometres of white sand, one of the longest undeveloped beaches in Asia",
          "Port Barton area: the cluster of small settlements at the beach's southern approach, with simple accommodation and good seafood",
        ],
        img: null,
      },
      {
        ...
        desc: "A full day on a beach that asks nothing of you. The rhythm of Long Beach is set by the tide and the light, not by schedules. Walk the length of it in the morning when the sand is still cool. Rent a kayak in the afternoon and paddle along the coast. The local fishermen work the channel behind the beach at low tide and will often sell fresh catch directly from the boat. This is slow travel in the most literal sense.",
        bullets: [
          "Long Beach at low tide: the sandbar extends several hundred metres, the water knee deep and clear",
          "Kayaking along the coast: the islands visible offshore from Long Beach are accessible by paddle",
          "Maoyon River mouth: the mangrove estuary at the beach's northern end, reachable by kayak",
          "Sunset on Long Beach: the western exposure makes this one of the finest sunset vantage points in Palawan",
        ],
        img: null,
      },
      {
        ...
        desc: "Transfer north to El Nido by shared van or private car along Palawan's coast road, passing through small towns and stretches of forest where the jungle comes down to the road. El Nido sits at Palawan's northern tip, surrounded on three sides by the karst limestone towers of the Bacuit Archipelago. Arriving in the late afternoon, the first view of the bay from the town waterfront is the orienting moment: the islands are out there, and tomorrow the boats go out.",
        bullets: [
          "El Nido town: the small settlement at Palawan's northern tip, the gateway to the Bacuit Archipelago",
          "Bacuit Bay: the sheltered bay facing the fifty-island archipelago, visible from the waterfront",
          "Las Cabanas Beach: the sunset beach south of town, reached by tricycle in under fifteen minutes",
          "The El Nido waterfront: where the bancas depart each morning for the archipelago tours",
        ],
      ...
      },
      {
        ...
        desc: "The first day out on the water. Private banca through the Bacuit Archipelago to Miniloc Island: the Big Lagoon, its turquoise water enclosed by vertical limestone walls that rise forty metres from the surface. At low tide a gap in the rock opens into the Small Lagoon, accessible only by kayak. Snake Island sandbar in the afternoon: a curved strip of white sand that appears and disappears with the tide. The coral between stops is intact and the fish are plentiful.",
        bullets: [
          "Big Lagoon, Miniloc Island: a turquoise enclosure ringed by vertical limestone, the most photographed lagoon in Palawan",
          "Small Lagoon: accessible at low tide only, through a narrow passage in the rock wall",
          "Snake Island sandbar: the curved sand isthmus that appears between two islands at low tide",
          "Seven Commandos Beach: the white sand beach on Palawan's west coast for the afternoon",
        ],
      ...
      },
      {
        ...
        desc: "The second route through the archipelago. Secret Lagoon on Miniloc: reached by squeezing through a crevice in the limestone at low tide into a circular hidden space the size of a small stadium. Shimizu Island for snorkelling over the best coral in the Bacuit Archipelago, the reef intact and the fish density high enough to be disorienting. Matinloc Shrine on its limestone cliff above the Tapiutan Strait. Helicopter Island beach for the afternoon, named for the silhouette visible from above.",
        bullets: [
          ...
          "Helicopter Island: the beach below the island silhouette that gives it its name",
        ],
      ...
      },
      {
        ...
        desc: "The day away from the boats. Drive north of El Nido town along a dirt road through coconut groves to Nacpan Beach: four kilometres of white sand facing the South China Sea, with almost no facilities and almost no visitors. One of the finest beaches in the Philippines, and consistently overlooked because the road is rough and the journey requires patience. The Twin Beaches viewpoint connects Nacpan to neighbouring Calitang Beach, the two meeting at a strip of sand passable on foot at low tide.",
        bullets: [
          ...
          "Calitang Beach: the neighbouring beach south of the viewpoint, quieter still than Nacpan",
          "The drive north: a dirt road through coconut groves that filters out everyone unwilling to make the effort",
        ],
        img: null,
      },
      {
        ...
        desc: "A final morning on the water before the move south. The outer islands of the Bacuit Archipelago, away from the standard tour boat circuits, offer a different quality of silence. A private charter to Cadlao Island or the reefs around Papaya Beach gives access to water and shoreline that the tour groups rarely reach. The afternoon is for El Nido town: the market, a meal, and the last evening watching the limestone towers turn gold.",
        bullets: [
          ...
          "El Nido town at dusk: the karst towers above the bay catch the last light in a way that justifies the trip",
        ],
        img: null,
      },
      {
        day: 9,
        title: "El Nido to Coron — The Ferry South",
        route: "El Nido · Coron",
        desc: "Take the fast ferry south from El Nido through the Calamian island group to Coron: a four hour crossing through waters that change character as the Bacuit limestone towers give way to the broader, flatter Busuanga landscape. Coron operates at a different register: the same clarity of water, the same density of islands, but with a history below the surface that El Nido does not have. On 24 September 1944, a US Navy air strike sank 24 Japanese supply ships in Coron Bay, and twelve of them are now among the most extraordinary dive sites in the world.",
        bullets: [
          "El Nido to Coron fast ferry: a four hour crossing through the Calamian island group",
          "Coron town: the small market settlement on Busuanga Island above the WWII wreck sites",
          "Coron Bay: the sheltered bay flanked by karst limestone islands, the shipwrecks below the surface",
          "Mount Tapyas: the hill above Coron town with a concrete staircase to a viewpoint over the bay",
        ],
      ...
      {
        day: 11,
        title: "Coron — The WWII Shipwrecks",
        route: "Coron · Coron Bay · Shipwrecks",
        desc: "The wreck dives. Twelve Japanese supply ships rest in Coron Bay at depths between 10 and 40 metres, their structures colonised by coral and circled by fish in numbers that suggest the wrecks have become the reef they never had. The Okikawa Maru, the Irako, the Morazan Maru. Non-divers can snorkel the shallower sites. There is nothing comparable in Southeast Asia: an entire fleet, still largely intact, given back to the ocean.",
        bullets: [
          "Okikawa Maru: the oil tanker wreck at 10 to 47 metres, the shallowest and most accessible of the fleet",
          "Irako: the provisioning ship at 40 metres, its structure largely intact after more than eighty years",
          "Morazan Maru: the largest of the Coron wrecks, resting at 33 metres",
          "Lusong Gunboat: the Japanese gunboat in 10 metres of water, accessible to snorkellers without dive equipment",
        ],
        img: null,
      },
      {
        day: 12,
        title: "Coron to Boracay — Arrival at White Beach",
        route: "Coron · Busuanga · Boracay · White Beach",
        desc: "Fly from Busuanga to Caticlan and take the short banca crossing to Boracay. The island is four kilometres long. White Beach runs along its entire western shore: the four kilometre arc of fine white sand that made Boracay famous in the 1980s and overfamous in the decades that followed. The northern end, Station 1, is quieter, the accommodation more considered, the stretch of beach less managed. This is where the route settles.",
        bullets: [
          "Boracay island: four kilometres long, most development concentrated on White Beach's western shore",
          "Station 1: the quieter northern end of White Beach, with calmer water and better accommodation options",
          "D'Mall: the commercial centre of the island, useful for orientation on arrival",
          "White Beach at sunset: the western exposure that made Boracay famous, a genuinely good sunset regardless of its reputation",
        ],
      ...
      },
      {
        ...
        bullets: [
          ...
          "Snorkelling at Ariel's Point: coral accessible only by boat, away from the White Beach reef crowds",
          "White Beach final afternoon: a last swim on the main beach before the day closes",
      ...
      },
      {
        ...
        desc: "Ferry from Boracay to Caticlan, then fly to Manila. If the schedule allows, the Makati district is reachable from the airport in under an hour: the most navigable part of Manila, with good hotels, a walkable grid of streets, and restaurants that would hold their own in any city. A final night in the city before the departure tomorrow.",
        bullets: [
          "Boracay to Caticlan ferry: the ten minute banca crossing to the mainland at Malay",
          "Caticlan to Manila: the domestic flight returning to Ninoy Aquino International Airport",
          "Makati: Manila's financial district, the city's most ordered neighbourhood and its best food destination",
          "Greenbelt and Salcedo Village: the walkable dining and park area in the heart of Makati",
        ],
        img: null,
      },
      {
        day: 16,
        title: "Manila — Intramuros and BGC",
        route: "Manila · Intramuros · BGC",
        desc: "A final day in Manila with time to use properly. Intramuros in the morning: the Spanish walled city built in 1571, with Fort Santiago, the Cathedral, and the Rizal Shrine telling the city's colonial history in a compact and walkable area. Bonifacio Global City in the afternoon: the contemporary district that opened on the site of the former Fort Bonifacio military base, with rooftop restaurants and a view of the city that makes sense of everything below.",
        bullets: [
          "Intramuros: the Spanish colonial walled city at the mouth of the Pasig River, built in 1571",
          "Fort Santiago: the 16th-century citadel where José Rizal was imprisoned before his execution in 1896",
          "Manila Cathedral: the Baroque cathedral rebuilt seven times since 1581, still in use and still impressive",
          "Bonifacio Global City: the contemporary district on the former US military base, with rooftop restaurants and skyline views",
        ],
        img: null,
      },
      {
