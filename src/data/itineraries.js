...
export const itineraries = [
...

  {
    ...
    days: [
      ...
      {
        day: 5,
        title: "El Nido — The Lagoons",
        route: "El Nido · Miniloc Island",
        desc: "The first morning on the water is the one that orients everything else. A private banca to Miniloc Island and the Big Lagoon: vertical limestone walls rising forty metres from the surface, enclosing a body of turquoise water that earns every photograph taken of it. At low tide, a gap in the cliff opens into the Small Lagoon, reached by kayak through a narrow passage in the rock. Both can be visited in a single morning, leaving the afternoon quiet. The archipelago is not for rushing.",
        bullets: [
          "Big Lagoon, Miniloc Island: turquoise water enclosed by vertical limestone walls, the defining El Nido experience",
          "Small Lagoon: entered at low tide through a narrow gap in the rock, by kayak only",
          "The afternoon at leisure: the waterfront at El Nido town or the beach south of the pier",
        ],
      ...
      {
        day: 6,
        title: "El Nido — Shimizu and the Quiet Side",
        route: "El Nido · Shimizu Island",
        desc: "The second boat day takes a different character. Shimizu Island holds the best snorkelling reef in the Bacuit Archipelago: the coral intact, the fish density high enough to be genuinely disorienting. On a private charter that avoids the shared-tour schedule, it is also one of the quieter stops in the archipelago. Arrive before the group boats, stay as long as the reef holds interest, then move to a small beach accessible only by water for the afternoon. The contrast with the day before is intentional.",
        bullets: [
          "Shimizu Island: the best coral reef in the Bacuit Archipelago, with intact structure and dense fish populations",
          "A private schedule: arriving before the shared tours and leaving when ready changes the experience entirely",
          "Afternoon at a quiet beach: one of several small beaches in the outer archipelago accessible only by boat",
        ],
        img: null,
      },
      {
      ...
      },
      {
        ...
        desc: "The last El Nido evening is for the boat. A private banca leaves in the late afternoon and anchors between the limestone towers as the light changes. The karst islands absorb colour differently as the sun drops: first gold, then amber, then the quality of dusk that exists only in places where there is no artificial light to compete with it. No snorkelling stops, no agenda beyond the water and the light. The ferry to Coron leaves at 6am the following morning.",
        bullets: [
      ...
      {
        day: 16,
        title: "Makati — Final Night",
        route: "Manila · Makati",
        desc: "The last night before the international flight. Makati is the right place to end: ordered, well-served, and close enough to the airport that tomorrow's early departure does not require planning around. A good dinner in Legazpi or Salcedo Village. A proper night's sleep. The itinerary is complete.",
        bullets: [
          "Makati: Manila's most navigable district, within 45 minutes of Ninoy Aquino International Airport",
          "Legazpi and Salcedo villages: the residential dining area with a consistent range of good restaurants",
          "Preparation for departure: an early night before the international connection",
        ],
        img: null,
      },
      {
