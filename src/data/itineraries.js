...
export const itineraries = [
...

  {
    ...
    routeOverview: "Algeciras/Tarifa → Ceuta/Tangier Med → Chefchaouen → Fes → Middle Atlas → Errachidia → Erfoud → Rissani → Merzouga (2 nights) → Tinghir → Todra Gorge → Dades Valley → Skoura → Ouarzazate → Aït Benhaddou → Tizi n'Tichka → Marrakech → Atlantic Coast → Oualidia → Casablanca → Rabat → Tangier → Ferry home",
  },
