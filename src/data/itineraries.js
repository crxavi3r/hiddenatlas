...
export const itineraries = [
...

  {
    ...
    included: [
      "Complete 17-day itinerary with island logistics and boat schedules",
    ...
    days: [
      ...
      {
        day: 14,
        title: "Boracay — Bulabog Beach & the East Coast",
        route: "Boracay · Bulabog Beach",
        desc: "The half of Boracay that most visitors miss. Bulabog Beach on the island's eastern shore faces the Sibuyan Sea and catches the trade winds, making it the site of the Philippines' best kitesurfing. The beach itself is narrower and less manicured than White Beach, with outrigger boats instead of sun loungers. Walk the cross-island trail connecting the two coasts: fifteen minutes through coconut groves, the island narrowed to a few hundred metres.",
        bullets: [
          "Bulabog Beach — Boracay's east coast, the kitesurfing and windsurfing shore facing the Sibuyan Sea",
          "The cross-island trail — the 15-minute path through the island's narrow interior linking both coasts",
          "Mount Luho viewpoint — Boracay's highest point at 100 metres, with open views across both shores",
          "Talipapa market — the small local wet market behind D'Mall, where the island actually shops",
        ],
        img: null,
      },
      {
        day: 15,
        title: "Boracay — Final Day on White Beach",
        route: "Boracay · White Beach",
        desc: "The last full day on the island. White Beach in the early morning before the beach fills is the calmest and most beautiful hour on Boracay: the fishing bancas still returning, the sand unoccupied. A slow morning, a long lunch at the Station 1 end, and a final paraw sailing at sunset — the traditional outrigger canoe that navigates White Beach every evening.",
        bullets: [
          "White Beach at dawn — the most peaceful hour on Boracay's main beach, before the crowds arrive",
          "Station 1 restaurants — the quieter northern end of White Beach, the island's best dining",
          "Paraw sailing at sunset — the traditional Filipino outrigger canoe, the Boracay institution",
          "Willy's Rock — the small volcanic rock with a Marian shrine standing in the White Beach shallows",
        ],
        img: null,
      },
      {
        ...
        desc: "Morning ferry from Boracay to Caticlan. Flight to Manila's Ninoy Aquino International Airport. If the schedule allows, the BGC district is thirty minutes from the terminal: a final afternoon in the Philippines' most contemporary neighbourhood, with rooftop restaurants and the kind of evening meal that sends you home content.",
        bullets: [
          ...
          "Manila BGC — the Bonifacio Global City dining district near the airport, the city at its most current",
        ],
        img: null,
      },
      {
        ...
        route: "Manila",
        desc: "International departure from Ninoy Aquino International Airport. The Philippines stays with you: the colour of the water inside Kayangan Lake, the scale of the karst towers from a boat in Bacuit Bay, the stillness of the lagoons at Coron. Most destinations fade. This one doesn't.",
        bullets: [
          ...
          "Direct connections to Hong Kong, Singapore, Tokyo, Dubai and European hub airports",
        ],
        img: null,
      },
    ],
    ...
    routeOverview: "Manila (1 night) → Puerto Princesa (1 night) → El Nido (4 nights) → overnight ferry → Coron (3 nights) → Boracay (5 nights) → Manila (1 night) → Departure",
  },
